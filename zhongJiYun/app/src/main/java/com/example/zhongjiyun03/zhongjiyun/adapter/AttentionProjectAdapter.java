 ...
 */
public class AttentionProjectAdapter extends AppBaseAdapter<AttentionProjectBean> {
    private ViewHold viewHold;


    public AttentionProjectAdapter(List<AttentionProjectBean> data, Context context) {
        super(data, context);
    }
