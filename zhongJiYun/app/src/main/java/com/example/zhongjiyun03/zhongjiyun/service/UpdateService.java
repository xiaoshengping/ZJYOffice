...
public class UpdateService extends Service {
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
				case DOWN_OK:
					...
					Notification noti = new Notification.Builder(UpdateService.this)
							.setContentTitle(app_name)
							.setContentText(getString(R.string.down_sucess))
							.setContentIntent(pendingIntent)
							.build();
					notificationManager.notify(R.layout.notification_item, noti);
				...
				case DOWN_ERROR:
					...
					Notification noti1 = new Notification.Builder(UpdateService.this)
							.setContentTitle(app_name)
							.setContentText(getString(R.string.down_sucess))
							.setContentIntent(pendingIntent)
							.build();
	...
	public void createNotification() {
		...
		notification = new Notification(
				...
				R.mipmap.application_logo_icon,//应用的图标
