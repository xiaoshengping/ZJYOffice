...
public class PingPayActivity extends AppCompatActivity implements View.OnClickListener, PayResultCallBack {
...
/**
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        wechatButton.setOnClickListener(PingPayActivity.this);
        alipayButton.setOnClickListener(PingPayActivity.this);
        upmpButton.setOnClickListener(PingPayActivity.this);
        bfbButton.setOnClickListener(PingPayActivity.this);
        jdpayButton.setOnClickListener(PingPayActivity.this);
...
/**
        ...
        protected void onPostExecute(String data) {
            ...
            Log.d("charge", data);
            Intent intent = new Intent(PingPayActivity.this, PaymentActivity.class);
