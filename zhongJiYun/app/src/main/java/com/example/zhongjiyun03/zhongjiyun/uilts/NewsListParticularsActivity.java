...
public class NewsListParticularsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_news_list_particulars);
    ...
    private void intiView() {
        ...
        titleNemeTv.setText("新闻详情");
        retrunText.setOnClickListener(this);
       String url= AppUtilsUrl.BaseUrl+"app/index.html#/tab/my/news-details?id="+getIntent().getStringExtra("newDataId");
        //webView.loadUrl();
