 ...
 *
 */
public class RootAdressListViewAdapter extends BaseAdapter {
    ...
    private List<ProvinceCityBean> items;
    ...
    public RootAdressListViewAdapter(Context context){
    ...
    public void setItems(List<ProvinceCityBean> items) {
        this.items = items;
    }
...
//          Drawable item_bg = new ColorDrawable(R.color.sub_list_color);
        ...
        holder.item_text.setText(items.get(position).getName());
        return convertView;
    }
    class ViewHolder{
        TextView item_text;
