...
public class FirstClassAdapter extends BaseAdapter {
    ...
    public FirstClassAdapter(Context context, List<ProvinceCityBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (list.get(position).getProvinceCityChilds() != null && list.get(position).getProvinceCityChilds().size() > 0) {
