...
public class MoreDuoBaoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_more_duo_bao);
    ...
    private void initView() {
        ...
        titleNemeTv.setText("云币夺宝");
        retrunText.setOnClickListener(this);
        mSVProgressHUD = new SVProgressHUD(this);

        SQLhelper sqLhelper=new SQLhelper(MoreDuoBaoActivity.this);
    ...
    private void LoadUrl(String uid) {
        ...
        webView.setWebChromeClient(new WebChromeClient()
        {
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg) {
                ...
                i.setType("image/*");
                MoreDuoBaoActivity.this.startActivityForResult(Intent.createChooser(i,"File Chooserq"), 1);
            ...
            public void openFileChooser( ValueCallback uploadMsg, String acceptType ) {
                ...
                i.addCategory(Intent.CATEGORY_OPENABLE);
                i.setType("*/*");
                MoreDuoBaoActivity.this.startActivityForResult(Intent.createChooser(i, "File Browser"),	           1);
            }
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture){
                ...
                i.addCategory(Intent.CATEGORY_OPENABLE);
                i.setType("image/*");
                MoreDuoBaoActivity.this.startActivityForResult( Intent.createChooser( i, "File Chooser" ), 1 );
            }
            @Override
